window.expParam = {
  ...
  prequestions: [{
    ...
    question: "In the image below, we have opened 3 boxes.<br><img src=\"./img/sc3.png\"><br><br>The box that you opened most recently (40) is in bold.<br><br> You have accrued 15 points in costs.<br><br> If you clicked on no more boxes and clicked continue, you would receive 80 points minus 15 points in search costs for a total of 65 points.",
    type: 'text',
    title: 'Task Description',
    scroll: true
  }, {
