window.expParam = {
  ...
  instructionTextFirstC: "You can open as many of these boxes as you want, but must open at least one. After opening each box, you can open another box or stop searching by waiting until the timer runs out.",
  instructionTextSecondC: "It costs you 1 point each to learn about each movie. You can learn about as many of these movies as you want, but must learn about at least one. After learning about a movie, you can learn about another one or stop searching by waiting until the timer runs out.",
  postquestionsFirstC: [{
